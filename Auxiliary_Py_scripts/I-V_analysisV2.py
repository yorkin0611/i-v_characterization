# I-V_analysis Version 2 contains several lines of code for different ways
# of controlling input and output of data, with intent to make things more automatized.
# It should serve as transitional version.
...
#darkIV = "DarkIV-1" Insert the name of dark I-V curve file, including the extenstion.

lightIV = getfile(title="Select light IV measurement file:")
#lightIV = "LightIV-1" # Insert the name of light I-V curve file, including the extenstion.
